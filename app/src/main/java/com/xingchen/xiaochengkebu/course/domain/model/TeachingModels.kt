package com.xingchen.xiaochengkebu.course.domain.model
...
/** Stable identity used when merging backups without duplicating semesters. */
fun Semester.stableKey(): String = "${name.trim()}|$startEpochDay|$endEpochDay"
